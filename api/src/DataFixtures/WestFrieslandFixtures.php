...
class WestFrieslandFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"c2e9824e-2566-460f-ab4c-905f20cddb6c"])]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"bdae2f7b-21c3-4d88-be6d-a35b31c13916"])]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"3b6a637d-19c6-4730-b322-c03d0d8301b6"])]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"b1fd7b38-384b-47ec-a0f2-6f81949cdece"])]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"8f9adb13-d5e0-40de-a08c-a2ce5a648b1e"])]);
       // $section->setProperties(["https://vtc.westfriesland.commonground.nu/properties/8f9adb13-d5e0-40de-a08c-a2ce5a648b1e"]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"db69ce35-4ae1-4aac-936f-bdb5d4d1ff18"])]);
        ...
        $section->setProperties([$this->commonGroundService->cleanUrl(["component"=>"vtc","type"=>"request_types","id"=>"24d3e05d-26c2-4adb-acd4-08bde88b4526"])]);
